...
Apply the new environments to etcd2 daemon. You can read more about etcd2
certificates here.
...
You can also write your host IP addresses into `/etc/network-environment` file
using this utility.

Then you can run your Docker containers following way:
